...
Adicionalmente, a generalização foi avaliada com o conjunto \textit{FlipBias} \cite{chen2018learning}, que contém $2.781$ eventos sob múltiplas perspectivas. 
Os experimentos seguiram as diretrizes de Lin et al. [2025] para aferir a robustez das representações em dados 
não expostos durante a etapa de treinamento.
