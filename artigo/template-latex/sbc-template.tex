...
seja mantida em todas as etapas, evitando resultados enviesados e permitindo medir com precisão a capacidade do modelo em classificar novos dados \cite{nti2021performance}.
...
Esta metodologia permitiu uma comparação sistemática e rigorosa entre os \textit{baselines} estabelecidos por
Baly et al. [2020] -- que operam sob uma configuração de aprendizado tradicional -- e as variantes propostas neste
trabalho, que integram funções \textit{Contrastive Loss} e \textit{Triplet Loss} para o refinamento do espaço de características, como
observado na Tabela.
